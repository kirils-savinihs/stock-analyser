...
public class JavaMailTest {
    ...
    private static List<CompanyStockData> data = new ArrayList<>();
    ...
    public void test00Exceptions() throws Exception{
        CompanyStockData dat = new CompanyStockData("AES");
        ...
        mail.SendMessage(rec, data, data, data);
    ...
    public void test01FormSQL() {
        try {
            mail = new JavaMail();
            mail.recipients=new ArrayList<>();
            List<String> result=mail.FormSQL();
            conn = mail.conn;
            assertNotEquals("StockSending.JavaMail connection is not initialized", null, conn);
    ...
    public void test02SendMessageTRUE() {
        try {
            ...
            rec.add("test018@gmail.com");
            mail = new JavaMail();
            boolean result = mail.SendMessage(rec, data, data, data);
